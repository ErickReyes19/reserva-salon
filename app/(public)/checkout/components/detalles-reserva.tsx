...
import { Calendar, Clock, User, ArrowRight, CalendarCheck } from "lucide-react"
...
export function ReservationDetails({
  ...
  // Calculate end hour (start hour + 1)
        ...
        <div className="flex border-b">
          ...
          <div className="w-1/3 bg-blue-50 p-6 flex flex-col items-center justify-center border-r">
            <div className="text-center">
              ...
              <div className="text-blue-800 font-medium text-sm mt-2">{hour}:00 - {endHour}:00</div>
            </div>
          </div>
